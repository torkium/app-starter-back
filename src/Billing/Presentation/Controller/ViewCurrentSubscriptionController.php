...
final class ViewCurrentSubscriptionController
{
    #[Route('/api/billing/subscription', name: 'api_billing_subscription', methods: ['GET'])]
    public function __invoke(Security $security, BillingManager $billingManager): JsonResponse
    {
        ...
        return new JsonResponse($billingManager->currentSubscription($user));
    }
}
