...
{
    #[Route('/api/account/change-email/confirm', name: 'api_account_change_email_confirm', methods: ['POST'])]
    ...
    ): JsonResponse
    {
        ...
        $identityManager->confirmEmailChange((string) $payload['token']);

        return new JsonResponse(['status' => 'email_changed']);
    }
